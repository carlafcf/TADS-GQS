...
class ProdutoViewsTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        Produto.objects.create(nome='Produto 2', fornecedor="F", qnt_em_estoque=0, preco_de_venda=10.50, desconto=5.00) #0.525
    ...
    def test_criar_produto_template(self):
        ...
        self.assertEquals(response.status_code, 200)
        self.assertTemplateUsed(response, 'Produtos/criar_produto.html')
