...
class ProdutoModelTest(TestCase):
    ...
    def setUpTestData(cls):
        Produto.objects.create(nome="Travesseiro", fornecedor="Forn. 3", preco_de_venda=30.10)
        Produto.objects.create(nome="Travesseiro", fornecedor="Forn. 2", preco_de_venda=29.99)
